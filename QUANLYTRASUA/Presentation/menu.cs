...
namespace WindowsFormsApp1
{
    public partial class menu : Form
    {
        ...
        private void menu_Load(object sender, EventArgs e)
        {
            ...
            dsMon.Add(new MonAn("Trà sữa boba", 120000, @"C:\Users\vanco\LTHDT-QUAN-LY-TRA-SUA\QUANLYTRASUA\Images\boba.png", "Trà sữa"));
            dsMon.Add(new MonAn("Trà sữa việt quất", 45000, @"C:\Users\vanco\LTHDT-QUAN-LY-TRA-SUA\QUANLYTRASUA\Images\tsvietquat.png", "Trà sữa"));
            dsMon.Add(new MonAn("Trà sữa màu xanh", 45000, @"C:\Users\vanco\LTHDT-QUAN-LY-TRA-SUA\QUANLYTRASUA\Images\tsmauxanh.png", "Trà sữa"));
            dsMon.Add(new MonAn("Trà sữa màu cam", 45000, @"C:\Users\vanco\LTHDT-QUAN-LY-TRA-SUA\QUANLYTRASUA\Images\tsmaucam.png", "Trà sữa"));
